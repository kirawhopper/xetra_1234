...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the list_files_in_prefix method in case of a wrong or 
        not existing prefix
        """
        # Expected results
    ...
    def test_read_csv_to_df_ok(self):
        """
        Test the read_csv_to_df method for reading 1 .csv file from the mocked s3 bucket
        """
        # Expected results
        key_exp = "test.csv"
        col1_exp = "col1"
    ...
    def test_write_df_to_s3_empty(self):
        """
        Test the write_df_to_s3 method within an empty DataFrame as input
        """
        # Expected results
        return_exp = None
        ...
        # Method execution
        with self.assertLogs() as logm:
            result = self.s3_bucket_connector.write_df_to_s3(df_empty, key, file_format)
            # Log test after method execution
            self.assertIn(log_exp, logm.output[0])
        # Test after method execution
    ...
    def test_write_df_to_s3_csv(self):
        """
        Tests if writting a csv file to write_df_to_s3 method succeeds
        """
        # Expected results
        return_exp = True
    ...
    def test_write_df_to_s3_parquet(self):
        """
        Tests if writting a parquet file to write_df_to_s3 method succeeds
        """
        # Expected results
        return_exp = True
        df_exp = pd.DataFrame([["A", "B"], ["C", "D"]], columns=["col1", "col2"])
    ...
    def test_write_df_to_s3_wrong_format(self):
        """
        Tests if writting non csv/parquet file to write_df_to_s3 method succeeds
        """
        # Expected results
        df_exp = pd.DataFrame([["A", "B"], ["C", "D"]], columns=["col1", "col2"])
        key_exp = "test.parquet"
    ...
    def test_esqueleton(self):
        """
        Reminder of test structure
        """
        # Expected results
        # Test init
        # Method execution
